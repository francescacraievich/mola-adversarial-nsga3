"""Tests for NSGA-II optimization (without ROS2 dependencies)."""
...
class TestNSGA2Integration:
    """Tests for NSGA-II integration with perturbation generator."""
    ...
    def test_nsga2_optimization_runs(self):
        """Test NSGA-II optimization runs without errors."""
...
class TestHistoryCallback:
    ...
    def test_callback_saves_history(self):
        ...
        minimize(
            SimpleProblem(),
            NSGA2(pop_size=10, sampling=FloatRandomSampling()),
            ("n_gen", 3),
            seed=42,
            verbose=False,
            callback=callback,
